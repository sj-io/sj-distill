...
description: |
  A (mostly) comprehensive list of federal housing legislation, organized by decade and president in office.
author:
  - name: Sarah Johnson
date: 2022-06-18
categories:
...
**Section 1011** directed HUD "to conduct research about the 'ecological factors involved in urban living' and also to conduct studies and demonstrations on *ways to apply **innovative technologies** to housing construction, rehabilitation, and maintenance and to urban development activities.*" [@watkins2022]

<aside>

([P.L. 89-754, November 3, 1966](https://uslaw.link/citation/us-law/public/89/754))
...
The Act "established a 10-year housing goal of 26 million new homes, 6 million of them for low- and moderate-income families. The same act directed HUD (**Section 108**) to encourage the **use of new technologies** in the development of low-income housing.

This mandate called for HUD to solicit and approve no more than five plans by public or private entities to develop low-income housing 'using new and advanced technologies... where local building regulations permit the construction of experimental housing,' or where local zoning law permits variances for the construction of 'experimental housing.'" [@watkins2022]
...
**Title V** of this Act "re-emphasized Section 108 of the 1968 HUD Act. It stated 'the Secretary shall require, to the greatest extent feasible, the employment of **new and improved technologies**, methods, and materials in housing construction, rehabilitation, and maintenance... with a view to reducing costs, and shall encourage and promote the acceptance and application of such advanced technology, methods, and materials by all segments of the housing industry.'" [@watkins2022]

<aside>

([P.L. 91-609, December 31, 1970](https://uslaw.link/citation/us-law/public/91/609))
