...
ggplot(GRAPHItotal, aes(x = burden, y = estimate, fill = tenure)) +
  ...
  labs(title = "Cost burden by tenure for households in Memphis, TN",
...
ggplot(GRAPHItotal, aes(x = burden, y = estimate, fill = tenure)) +
  ...
  theme_minimal() +
  scale_fill_manual(values = c("mediumturquoise", "salmon")) +
  labs(title = "Cost burden by income by tenure for households in Memphis, TN",
       caption = "2015-2019 5-year ACS estimates",
       y = "",
       x = "",
       fill = "Tenure")
...
ggplot(GRAPHIdetMem, aes(x = variable, y = percent, fill = variable)) +
  ...
  labs(title = "Cost burden for renter-occupied households in Memphis, TN",
       caption = "2015-2019 5-year ACS estimates",
       y = "",
       x = "",
       fill = "")
...
ggplot(GRAPHIdetMem2, aes(x = income, y = estimate, fill = burden)) +
  ...
  theme_minimal() +
  scale_fill_manual(values = c("mediumseagreen", "goldenrod", "tomato")) +
  labs(title = "Cost burden by income for renter-occupied households in Memphis, TN",
       caption = "2015-2019 5-year ACS estimates",
       y = "",
       x = "",
       fill = "Cost Burden") 
...
The final portion of this section will touch on a few more characteristics of households who rent.
...
This final section looks into certain qualities of housing in Memphis. First I will look into the year built for renter-occupied housing. Then I will use data from the American Housing survey to identify common housing quality problems that renters experience.
