...
To understand a place, we need to look further than the city limits and also study the surrounding area. One way to do this is to analyze Census metro and micro areas.
...
[^1]: You can also access this data from <https://www.ipums.org/>.
...
This gives us an outline of Shelby County (not shown).

## Places within County

There is a decent amount of rural space in Shelby County. We can see this by finding all the `places()` in the county.
...
Below is an interactive map of the plots in this section.
