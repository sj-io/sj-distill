...
![Census Geographic Hierarchy](census-hierarchy.png)
...
```{r mapMake, layout="l-screen-inset", fig.height=9, fig.cap="Interactive leaflet map of Memphis boundaries"}
map %>% hideGroup(
  c(
    "CSA Counties",
    "Urban Area",
